...
class APIModelsLandlord {
     ...
     */
    constructor(landlordType, title, firstName, lastName, addressLine1, postcode) { 
     ...
     */
    static initialize(obj, landlordType, title, firstName, lastName, addressLine1, postcode) { 
...
export default APIModelsLandlord;
