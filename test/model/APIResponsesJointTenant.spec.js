...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MydepositsDeveloperApi.APIResponsesJointTenant();
  });
  ...
  describe('APIResponsesJointTenant', function() {
    it('should create an instance of APIResponsesJointTenant', function() {
      // uncomment below and update the code to test APIResponsesJointTenant
      //var instane = new MydepositsDeveloperApi.APIResponsesJointTenant();
      //expect(instance).to.be.a(MydepositsDeveloperApi.APIResponsesJointTenant);
    });
