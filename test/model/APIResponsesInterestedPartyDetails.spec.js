...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MydepositsDeveloperApi.APIResponsesInterestedPartyDetails();
  });
  ...
  describe('APIResponsesInterestedPartyDetails', function() {
    it('should create an instance of APIResponsesInterestedPartyDetails', function() {
      // uncomment below and update the code to test APIResponsesInterestedPartyDetails
      //var instane = new MydepositsDeveloperApi.APIResponsesInterestedPartyDetails();
      //expect(instance).to.be.a(MydepositsDeveloperApi.APIResponsesInterestedPartyDetails);
    });

    it('should have the property interestedPartyID (base name: "interestedPartyID")', function() {
      // uncomment below and update the code to test the property interestedPartyID
      //var instane = new MydepositsDeveloperApi.APIResponsesInterestedPartyDetails();
