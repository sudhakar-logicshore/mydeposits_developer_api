...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MydepositsDeveloperApi.APIResponsesProtection();
  });
  ...
  describe('APIResponsesProtection', function() {
    it('should create an instance of APIResponsesProtection', function() {
      // uncomment below and update the code to test APIResponsesProtection
      //var instane = new MydepositsDeveloperApi.APIResponsesProtection();
      //expect(instance).to.be.a(MydepositsDeveloperApi.APIResponsesProtection);
    });
