...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MydepositsDeveloperApi.APIResponsesBatchAddTenancy();
  });
  ...
  describe('APIResponsesBatchAddTenancy', function() {
    it('should create an instance of APIResponsesBatchAddTenancy', function() {
      // uncomment below and update the code to test APIResponsesBatchAddTenancy
      //var instane = new MydepositsDeveloperApi.APIResponsesBatchAddTenancy();
      //expect(instance).to.be.a(MydepositsDeveloperApi.APIResponsesBatchAddTenancy);
    });
