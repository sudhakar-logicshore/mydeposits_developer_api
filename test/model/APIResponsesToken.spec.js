...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MydepositsDeveloperApi.APIResponsesToken();
  });
  ...
  describe('APIResponsesToken', function() {
    it('should create an instance of APIResponsesToken', function() {
      // uncomment below and update the code to test APIResponsesToken
      //var instane = new MydepositsDeveloperApi.APIResponsesToken();
      //expect(instance).to.be.a(MydepositsDeveloperApi.APIResponsesToken);
    });
