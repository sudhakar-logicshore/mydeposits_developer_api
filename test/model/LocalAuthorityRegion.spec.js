...
(function(root, factory) {
  ...
  describe('LocalAuthorityRegion', function() {
    it('should create an instance of LocalAuthorityRegion', function() {
      // uncomment below and update the code to test LocalAuthorityRegion
      //var instane = new MydepositsDeveloperApi.LocalAuthorityRegion();
      //expect(instance).to.be.a(MydepositsDeveloperApi.LocalAuthorityRegion);
    });
