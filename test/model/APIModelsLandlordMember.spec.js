...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MydepositsDeveloperApi.APIModelsLandlordMember();
  });
  ...
  describe('APIModelsLandlordMember', function() {
    it('should create an instance of APIModelsLandlordMember', function() {
      // uncomment below and update the code to test APIModelsLandlordMember
      //var instane = new MydepositsDeveloperApi.APIModelsLandlordMember();
      //expect(instance).to.be.a(MydepositsDeveloperApi.APIModelsLandlordMember);
    });
    ...
    it('should have the property workEmailAddress (base name: "workEmailAddress")', function() {
      // uncomment below and update the code to test the property workEmailAddress
      //var instane = new MydepositsDeveloperApi.APIModelsLandlordMember();
      //expect(instance).to.be();
    });
