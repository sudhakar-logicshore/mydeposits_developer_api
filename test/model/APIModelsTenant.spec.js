...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MydepositsDeveloperApi.APIModelsTenant();
  });
  ...
  describe('APIModelsTenant', function() {
    it('should create an instance of APIModelsTenant', function() {
      // uncomment below and update the code to test APIModelsTenant
      //var instane = new MydepositsDeveloperApi.APIModelsTenant();
      //expect(instance).to.be.a(MydepositsDeveloperApi.APIModelsTenant);
    });
