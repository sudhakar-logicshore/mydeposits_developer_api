...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MydepositsDeveloperApi.APIModelsBatch();
  });
  ...
  describe('APIModelsBatch', function() {
    it('should create an instance of APIModelsBatch', function() {
      // uncomment below and update the code to test APIModelsBatch
      //var instane = new MydepositsDeveloperApi.APIModelsBatch();
      //expect(instance).to.be.a(MydepositsDeveloperApi.APIModelsBatch);
    });
