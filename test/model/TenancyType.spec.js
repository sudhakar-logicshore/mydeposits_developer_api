...
(function(root, factory) {
  ...
  describe('TenancyType', function() {
    it('should create an instance of TenancyType', function() {
      // uncomment below and update the code to test TenancyType
      //var instane = new MydepositsDeveloperApi.TenancyType();
      //expect(instance).to.be.a(MydepositsDeveloperApi.TenancyType);
    });
