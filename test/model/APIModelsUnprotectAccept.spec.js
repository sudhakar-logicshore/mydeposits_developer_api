...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MydepositsDeveloperApi.APIModelsUnprotectAccept();
  });
  ...
  describe('APIModelsUnprotectAccept', function() {
    it('should create an instance of APIModelsUnprotectAccept', function() {
      // uncomment below and update the code to test APIModelsUnprotectAccept
      //var instane = new MydepositsDeveloperApi.APIModelsUnprotectAccept();
      //expect(instance).to.be.a(MydepositsDeveloperApi.APIModelsUnprotectAccept);
    });
