...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MydepositsDeveloperApi.APIModelsCheckout();
  });
  ...
  describe('APIModelsCheckout', function() {
    it('should create an instance of APIModelsCheckout', function() {
      // uncomment below and update the code to test APIModelsCheckout
      //var instane = new MydepositsDeveloperApi.APIModelsCheckout();
      //expect(instance).to.be.a(MydepositsDeveloperApi.APIModelsCheckout);
    });
