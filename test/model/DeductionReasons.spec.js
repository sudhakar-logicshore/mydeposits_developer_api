...
(function(root, factory) {
  ...
  describe('DeductionReasons', function() {
    it('should create an instance of DeductionReasons', function() {
      // uncomment below and update the code to test DeductionReasons
      //var instane = new MydepositsDeveloperApi.DeductionReasons();
      //expect(instance).to.be.a(MydepositsDeveloperApi.DeductionReasons);
    });
