...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MydepositsDeveloperApi.APIModelsInterestedParty();
  });
  ...
  describe('APIModelsInterestedParty', function() {
    it('should create an instance of APIModelsInterestedParty', function() {
      // uncomment below and update the code to test APIModelsInterestedParty
      //var instane = new MydepositsDeveloperApi.APIModelsInterestedParty();
      //expect(instance).to.be.a(MydepositsDeveloperApi.APIModelsInterestedParty);
    });
