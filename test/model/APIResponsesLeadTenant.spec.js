...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MydepositsDeveloperApi.APIResponsesLeadTenant();
  });
  ...
  describe('APIResponsesLeadTenant', function() {
    it('should create an instance of APIResponsesLeadTenant', function() {
      // uncomment below and update the code to test APIResponsesLeadTenant
      //var instane = new MydepositsDeveloperApi.APIResponsesLeadTenant();
      //expect(instance).to.be.a(MydepositsDeveloperApi.APIResponsesLeadTenant);
    });
