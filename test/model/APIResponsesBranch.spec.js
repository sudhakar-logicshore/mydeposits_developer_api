...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MydepositsDeveloperApi.APIResponsesBranch();
  });
  ...
  describe('APIResponsesBranch', function() {
    it('should create an instance of APIResponsesBranch', function() {
      // uncomment below and update the code to test APIResponsesBranch
      //var instane = new MydepositsDeveloperApi.APIResponsesBranch();
      //expect(instance).to.be.a(MydepositsDeveloperApi.APIResponsesBranch);
    });
