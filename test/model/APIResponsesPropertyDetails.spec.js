...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MydepositsDeveloperApi.APIResponsesPropertyDetails();
  });
  ...
  describe('APIResponsesPropertyDetails', function() {
    it('should create an instance of APIResponsesPropertyDetails', function() {
      // uncomment below and update the code to test APIResponsesPropertyDetails
      //var instane = new MydepositsDeveloperApi.APIResponsesPropertyDetails();
      //expect(instance).to.be.a(MydepositsDeveloperApi.APIResponsesPropertyDetails);
    });
