...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MydepositsDeveloperApi.APIResponsesBatch();
  });
  ...
  describe('APIResponsesBatch', function() {
    it('should create an instance of APIResponsesBatch', function() {
      // uncomment below and update the code to test APIResponsesBatch
      //var instane = new MydepositsDeveloperApi.APIResponsesBatch();
      //expect(instance).to.be.a(MydepositsDeveloperApi.APIResponsesBatch);
    });
