...
(function(root, factory) {
  ...
  describe('TenancyStatus', function() {
    it('should create an instance of TenancyStatus', function() {
      // uncomment below and update the code to test TenancyStatus
      //var instane = new MydepositsDeveloperApi.TenancyStatus();
      //expect(instance).to.be.a(MydepositsDeveloperApi.TenancyStatus);
    });
