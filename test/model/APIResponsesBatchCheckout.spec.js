...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MydepositsDeveloperApi.APIResponsesBatchCheckout();
  });
  ...
  describe('APIResponsesBatchCheckout', function() {
    it('should create an instance of APIResponsesBatchCheckout', function() {
      // uncomment below and update the code to test APIResponsesBatchCheckout
      //var instane = new MydepositsDeveloperApi.APIResponsesBatchCheckout();
      //expect(instance).to.be.a(MydepositsDeveloperApi.APIResponsesBatchCheckout);
    });

    it('should have the property paymentValue (base name: "paymentValue")', function() {
      // uncomment below and update the code to test the property paymentValue
      //var instane = new MydepositsDeveloperApi.APIResponsesBatchCheckout();
