...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MydepositsDeveloperApi.APIResponsesPaymentDetailsList();
  });
  ...
  describe('APIResponsesPaymentDetailsList', function() {
    it('should create an instance of APIResponsesPaymentDetailsList', function() {
      // uncomment below and update the code to test APIResponsesPaymentDetailsList
      //var instane = new MydepositsDeveloperApi.APIResponsesPaymentDetailsList();
      //expect(instance).to.be.a(MydepositsDeveloperApi.APIResponsesPaymentDetailsList);
    });
