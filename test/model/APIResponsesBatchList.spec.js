...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MydepositsDeveloperApi.APIResponsesBatchList();
  });
  ...
  describe('APIResponsesBatchList', function() {
    it('should create an instance of APIResponsesBatchList', function() {
      // uncomment below and update the code to test APIResponsesBatchList
      //var instane = new MydepositsDeveloperApi.APIResponsesBatchList();
      //expect(instance).to.be.a(MydepositsDeveloperApi.APIResponsesBatchList);
    });
