...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MydepositsDeveloperApi.APIModelsLandlord();
  });
  ...
  describe('APIModelsLandlord', function() {
    it('should create an instance of APIModelsLandlord', function() {
      // uncomment below and update the code to test APIModelsLandlord
      //var instane = new MydepositsDeveloperApi.APIModelsLandlord();
      //expect(instance).to.be.a(MydepositsDeveloperApi.APIModelsLandlord);
    });
